	...
	resources: {
		...
		Русский: {
			translations: {
				...
				'Warning: contains alcohol, it is recommended to avoid excessive drinking': 'Внимание: содержит алкоголь, рекомендуется избегать чрезмерного употребления.',
				'Warning! Excessive consumption of alcohol is life-threatening and harmful to health': 'Предупреждение! Чрезмерное употребление алкоголя опасно для жизни и вредно для здоровья',
				Wine: 'Вино',
				'Port wine': 'Портвейн',
				Cognac: 'Коньяк',
			},
		...
		עברית: {
			translations: {
				...
				"Warning: contains alcohol, it is recommended to avoid excessive drinking": "אזהרה: מכיל אלכוהול מומלץ להימנע משתיה מופרזת",
				"Warning! Excessive consumption of alcohol is life-threatening and harmful to health": "אזהרה! צריכה מופרזת של אלכוהול מסכנת חיים ומזיקה לבריאות",
				Wine: 'יַיִן',
